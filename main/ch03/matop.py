...
def func1():
    img1 = cv2.imread("./main/ch03/cat.bmp", cv2.IMREAD_GRAYSCALE)
...
def func2():
    ...
    mat1 = np.array([[11, 12, 13, 14], [21, 22, 23, 24], [31, 32, 33, 34]]).astype(
        np.uint8
    )
...
def func3():
    img1 = cv2.imread("./main/ch03/dog.bmp")
...
def func4():
    img1 = cv2.imread("./main/ch03/lenna.bmp", cv2.IMREAD_GRAYSCALE)
